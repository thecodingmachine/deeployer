...
expectValue "Testing the absence of a timestamp label in the service" "host.json" ".generatedConf.phpmyadmin.service.spec.selector.deeployerTimestamp" 'null' ../scripts/main.jsonnet
